                   ...
                   // alert("Data Received");
                    ...
                    if(Object.keys(responseJson).length){
                       ...
                       // alert('correct password')
                        ...
                        //false
                        alert('Enter corret password and user ID')
                    }
                    //return(responseJson);       
                  }).catch((error) => {
                ...
                >
                    <View style={styles.container}>
                        ...
                        <View style = {styles.inputBox}>
                            <TextInput style={styles.input } onChangeText={(text) => this.setState({user:text})}  value={this.setState.user} placeholder='Username' />
                            <TextInput style={styles.input} onChangeText={(text) => this.setState({pass:text})} value ={this.setState.pass}placeholder='Password' />
